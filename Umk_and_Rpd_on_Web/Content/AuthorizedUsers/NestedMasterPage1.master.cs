    ...
    public partial class NestedMasterPage1 : System.Web.UI.MasterPage {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            using (AcademiaDataSetTableAdapters.UMK_and_RPDTableAdapter adapter = new AcademiaDataSetTableAdapters.UMK_and_RPDTableAdapter()) {
                ...
                //если РПД/УМК просматривает преподаватель, который его создал, то разрешить сохранение изменений в базе данных
                if ((bool?)Session["AllowEditRpd"] == true) {
                    this.Save_Data_to_TmpContentsField(adapter);
                    this.Button_for_EndEditUMK_RPD.Visible = true;
                }
            }
        ...
        /// </summary>
        private void Save_Data_to_TmpContentsField(AcademiaDataSetTableAdapters.UMK_and_RPDTableAdapter adapter) {
