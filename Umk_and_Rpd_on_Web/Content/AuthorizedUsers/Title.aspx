        ...
        <SelectParameters>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <div class="div_with_select_params">
                        ...
                        <asp:DropDownList ID="DropDownList_FacDiscip" CssClass="selectliststyle" runat="server" AutoPostBack="True" DataSourceID="FacultyObjectDataSource" DataTextField="NameFaculty" DataValueField="CodFaculty" OnSelectedIndexChanged="FacultyDropDownList_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                    <div class="div_with_select_params">
                        <asp:Label ID="Label4" runat="server" CssClass="label_titleform" Text="Кафедра: <br/>(для дисциплины)"></asp:Label>
                        <asp:DropDownList ID="DropDownList_KafDiscip" runat="server" CssClass="selectliststyle" DataSourceID="KafsObjectDataSource" DataTextField="NameKaf" DataValueField="CodKaf" OnSelectedIndexChanged="KafsDropDownList_SelectedIndexChanged" AutoPostBack="True" ViewStateMode="Enabled" OnDataBound="DropDownList_KafDiscip_DataBound"></asp:DropDownList>
                    </div>
                    <div class="div_with_select_params">
                        <asp:Label ID="Label5" runat="server" CssClass="label_titleform" Text="Форма обучения: "></asp:Label>
                        <asp:DropDownList ID="DropDownList_FormStudy" CssClass="selectliststyle" runat="server" DataSourceID="ObjectDataSource_FormStudy" DataTextField="FormStudy" DataValueField="CodFormStudy" OnSelectedIndexChanged="DropDownList_FormStudy_SelectedIndexChanged" AutoPostBack="True" ViewStateMode="Enabled"></asp:DropDownList>
                    </div>
                    <div class="div_with_select_params">
                        <asp:Label ID="Label6" runat="server" CssClass="label_titleform" Text="Тип обучения: "></asp:Label>
                        <asp:DropDownList ID="DropDownList_TypeEdu" CssClass="selectliststyle" runat="server" DataSourceID="ObjectDataSource_TypeEdu" DataTextField="TypeEdu" DataValueField="CodTypeEdu" OnSelectedIndexChanged="DropDownList_TypeEdu_SelectedIndexChanged" AutoPostBack="True" ViewStateMode="Enabled"></asp:DropDownList>
                    </div>
                    <div class="div_with_select_params">
                        <asp:Label ID="Label7" runat="server" CssClass="label_titleform" Text="Направление подготовки: "></asp:Label>
                        <asp:DropDownList ID="DropDownList_Speciality" CssClass="selectliststyle" runat="server" DataSourceID="ObjectDataSource_Speciality" DataTextField="CodSpec_with_NameSpec" DataValueField="CodSpeciality" OnSelectedIndexChanged="DropDownList_Speciality_SelectedIndexChanged" AutoPostBack="True" ViewStateMode="Enabled" OnDataBound="DropDownList_Speciality_DataBound"></asp:DropDownList>
                    </div>
                    <div class="div_with_select_params">
                        <asp:Label ID="Label8" runat="server" CssClass="label_titleform" Text="Учебный план: "></asp:Label>
                        <asp:DropDownList ID="DropDownList_StudyPlans" CssClass="selectliststyle" runat="server" DataSourceID="ObjectDataSource_StudyPlan" DataTextField="NamePlan1" DataValueField="CodPlan" OnSelectedIndexChanged="DropDownList_StudyPlans_SelectedIndexChanged" AutoPostBack="True" ViewStateMode="Enabled" OnDataBound="DropDownList_StudyPlans_DataBound"></asp:DropDownList>
                    </div>
                    <div class="div_with_select_params">
                        <asp:Label ID="Label9" runat="server" CssClass="label_titleform" Text="Учебный год"></asp:Label>
                        <asp:DropDownList ID="DropDownList_StudyYear" CssClass="selectliststyle" runat="server" OnSelectedIndexChanged="DropDownList_for_uch_year_SelectedIndexChanged" AutoPostBack="True" ViewStateMode="Enabled"></asp:DropDownList>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>   
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="NagruzkaOnPrepGridView" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource_for_NagruzkaOnPrep" CssClass="GridViewCss" HeaderStyle-CssClass="HeaderGridView" CellPadding="10" OnDataBound="NagruzkaOnPrepGridView_DataBound" EnableViewState="False" ViewStateMode="Disabled" OnSelectedIndexChanged="NagruzkaOnPrepGridView_SelectedIndexChanged">
                        <Columns>
