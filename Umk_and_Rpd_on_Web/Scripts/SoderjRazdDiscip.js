; (function () {
    ...
    */
    ...
    function Update_Semestr_in_thme_or_lec() {
        ...
        while ((CurrentRow_InRazdelLesson < Table_for_soderjDiscip.rows.length - 1) && (Table_for_soderjDiscip.rows[++CurrentRow_InRazdelLesson].cells[0].innerText != "Раздел")) {
    ...
    */
    ...
    function AddRowInEnd_for_literature() {
        if(CurrentRow_InTableForLiterature == Table_for_literature.rows.length - 1){
            ...
            select.oninput = SoderjRazdDiscip.AddRowInEnd_for_literature; 

            tr.cells[0].appendChild(select);

            var inputText = document.createElement("input");
            inputText.type = "text";
            inputText.oninput = SoderjRazdDiscip.AddRowInEnd_for_literature;
            ...
            inputBtn.onclick = function () {
                SoderjRazdDiscip.AddRowInEnd_for_literature();
                SoderjRazdDiscip.ShowPopUp_for_find_liter('block');
            }
    ...
    */
    ...
    SoderjRazdDiscip.ClickOnCell_intbl_liter = ClickOnCell_intbl_liter;
    SoderjRazdDiscip.del_str_from_TableLiterature = del_str_from_TableLiterature;
    SoderjRazdDiscip.AddRowInEnd_for_literature = AddRowInEnd_for_literature;
    SoderjRazdDiscip.ShowPopUp_for_find_liter = ShowPopUp_for_find_liter;

    SoderjRazdDiscip.BackgroundColor_SelectStr_inFindLiter = BackgroundColor_SelectStr_inFindLiter;
    SoderjRazdDiscip.BackGround_OutStr_inFindLiter = BackGround_OutStr_inFindLiter;
    SoderjRazdDiscip.ClearAllElement_in_findLiterWindow = ClearAllElement_in_findLiterWindow;
    SoderjRazdDiscip.AddLiterToTextBox = AddLiterToTextBox;
